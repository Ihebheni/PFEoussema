    ...
    <aside
        ...
        <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="{{ route('admin.coachs.index') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">people</i> <!-- Icône pour Coachs -->
                        </div>
                        <span class="nav-link-text ms-1">Coachs</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="{{ route('admin.users.index') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">group</i> <!-- Icône pour Users -->
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="{{-- route('statistics.index') --}}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">insights</i> <!-- Icône pour Statistics -->
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="{{ route('admin.reclamations') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">feedback</i> <!-- Icône pour Reclamations -->
                        </div>
    ...
    <main class="main-content border-radius-lg">
        ...
        <div class="container-fluid py-4">
            ...
            @hasSection('content')
                @yield('content')
            @else
            @include('admin.sections.defaultcontent')
            @endif
